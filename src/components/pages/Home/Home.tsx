...
const Home = () => {
  ...
  const goals = [
    ...
    { title: "LSTMAE Model Familiarity", 
      content:
      `While I knew that the model was capable of achieving its task, I wanted to gain true insight on <i>how</i> exactly it achieved its task.
      I got to reading blogs and wikis, watching youtube videos, and trying to trace what happened to the data at each step of the process.
  ...
  return (
    <div className="page">
        ...
        <p>I was employed by Toyota Motor Manufacturing Canada (TMMC) working under the Information Systems (IS) team, specifically, the CAT (Current Analysis Tool) team. 
        ...
        <p>
          ...
          I will leave the specifics to experience. 
        </p>
        </div>
        ...
        <div className='box'>
          ...
          <p>Big thank you to Graham, Nick, Katie, Ben, Meredith, </p>
        </div>
        <br></br>
